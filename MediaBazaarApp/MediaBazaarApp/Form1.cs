...
namespace MediaBazaarApp
{
    public partial class Form1 : Form
    {
        ...
        private void btnAutoSchedule_Click(object sender, EventArgs e)
        {
            ...
            //    {
            //        offset = firstDayOfMonth.DayOfWeek - DayOfWeek.Monday;
            //        lastMonday = firstDayOfMonth.AddDays(-offset);
            //        nextSunday = lastMonday.AddDays(6);

            //        availableEmployees = this.scheduler.GetAvailableEmployees(firstDayOfMonth.ToString("d"), lastMonday.ToString("d"), nextSunday.ToString("d"));

            //        ///When we change the day we also reset the values of the employees needed for each shift
            //        employeesMorning = 0;
            //        employeesAfternoon = 0;
            //        employeesEvening = 0;

            //        ///When we change the day we also reset the values of the specific type of employees needed for each shift
            //        HR = 0;
            //        logistics = 0;
            //        productManagement = 0;
            //        depotManagement = 0;

            //        ///Check if we have the required number of employees for the morning shift
            //        if(employeesMorning<8)
            //        {
            //            foreach (Employee employee in availableEmployees)
            //            {
            //                if (employee.Department == "HR" && HR<2)
            //                {
            //                    if(employee.ContractType=="Full Time")
            //                    {
            //                        WorkShift shift = new WorkShift(employee.ID, employee.Name, firstDayOfMonth.ToString("d"), "MORNING", Convert.ToDecimal(employee.HourlyWage), 8);
            //                    }
            //                    else
            //                    {
            //                        WorkShift shift = new WorkShift(employee.ID, employee.Name, firstDayOfMonth.ToString("d"), "MORNING", Convert.ToDecimal(employee.HourlyWage), 6);
            //                    }
            ...
            //                if (employee.Department == "Logistics" && logistics<2)
            //                {
            //                    if (employee.ContractType == "Full Time")
            //                    {
            //                        WorkShift shift = new WorkShift(employee.ID, employee.Name, firstDayOfMonth.ToString("d"), "MORNING", Convert.ToDecimal(employee.HourlyWage), 8);
            ...
            //                if (employee.Department == "Product Management" && productManagement<2)
            //                {
            //                    if (employee.ContractType == "Full Time")
            //                    {
            //                        WorkShift shift = new WorkShift(employee.ID, employee.Name, firstDayOfMonth.ToString("d"), "MORNING", Convert.ToDecimal(employee.HourlyWage), 8);
            ...
            //                if (employee.Department == "Depot Management" && depotManagement<2)
            //                {
            //                    if (employee.ContractType == "Full Time")
            //                    {
            //                        WorkShift shift = new WorkShift(employee.ID, employee.Name, firstDayOfMonth.ToString("d"), "MORNING", Convert.ToDecimal(employee.HourlyWage), 8);
            ...
            //        ///Check if we have the required number of employees for the afternoon shift
            ...
            //                    if (employee.ContractType == "Full Time")
            //                    {
            //                        WorkShift shift = new WorkShift(employee.ID, employee.Name, firstDayOfMonth.ToString("d"), "AFTERNOON", Convert.ToDecimal(employee.HourlyWage), 8);
            //                    }
            //                    else
            //                    {
            //                        WorkShift shift = new WorkShift(employee.ID, employee.Name, firstDayOfMonth.ToString("d"), "AFTERNOON", Convert.ToDecimal(employee.HourlyWage), 6);
            //                    }
            ...
            //        ///Check if we have the required number of employees for the evening shift
            ...
            //                    if (employee.ContractType == "Full Time")
            //                    {
            //                        WorkShift shift = new WorkShift(employee.ID, employee.Name, firstDayOfMonth.ToString("d"), "EVENING", Convert.ToDecimal(employee.HourlyWage), 8);
            //                    }
            //                    else
            //                    {
            //                        WorkShift shift = new WorkShift(employee.ID, employee.Name, firstDayOfMonth.ToString("d"), "EVENING", Convert.ToDecimal(employee.HourlyWage), 6);
            //                    }
